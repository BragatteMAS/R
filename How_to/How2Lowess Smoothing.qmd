...
plot(x,
     y,
     main = "Raw Data with Non-linear Trend",
     col = "blue",
     pch = 16)
```

![](https://i2.wp.com/www.spsanderson.com/steveondata/posts/2024-01-02/index_files/figure-html/unnamed-chunk-1-1.png?w=450&ssl=1)
...
plot(x,
     y,
     main = "Lowess Smoothed",
     col = "blue",
     pch = 16)
lines(smoothed_data, col = "red", lwd = 2)
legend(
  "topleft",
  legend = c("Raw Data", "Lowess Smoothed"),
  col = c("blue", "red"),
  lwd = 2
)
...
![](https://i1.wp.com/www.spsanderson.com/steveondata/posts/2024-01-02/index_files/figure-html/unnamed-chunk-2-1.png?w=450&ssl=1)
...
plot(
  x,
  fitted_values,
  main = "Lowess Smoothed Model with Residuals",
  col = "red",
  type = "l",
  lwd = 2
)
...
legend(
  "topleft",
  legend = c("Smoothed Model", "Residuals"),
  col = c("red", "green"),
  lwd = 2
)
...
![](https://i1.wp.com/www.spsanderson.com/steveondata/posts/2024-01-02/index_files/figure-html/unnamed-chunk-3-1.png?w=450&ssl=1)
...
plot(x,
     y,
     main = "Comparison of Lowess Models",
     col = "blue",
     pch = 16)
...
legend(
  "bottomleft",
  legend = c("Raw Data", "Model 1", "Model 2", "Model 3"),
  col = c("blue", "red", "green", "purple"),
  lwd = 2
)
```

![](https://i2.wp.com/www.spsanderson.com/steveondata/posts/2024-01-02/index_files/figure-html/unnamed-chunk-4-1.png?w=450&ssl=1)
...
[Mastering Lowess Smoothing in R: A Step-by-Step Guide \| R-bloggers](https://www.r-bloggers.com/2024/01/mastering-lowess-smoothing-in-r-a-step-by-step-guide/?utm_source=phpList&utm_medium=email&utm_campaign=R-bloggers-weekly&utm_content=HTML)
