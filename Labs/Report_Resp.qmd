...
data_ultima_semana <- "2024-03-30" # Alterar a data conforme interesse e calendario SINAN
...
plot_ly() %>%
  ...
  layout(yaxis = list(title = 'Total de Testes'), xaxis = list(title = 'Resultado'),
         title = 'Quantidade de resultados positivos e negativos para VSR nas análises do ITpS')
```
