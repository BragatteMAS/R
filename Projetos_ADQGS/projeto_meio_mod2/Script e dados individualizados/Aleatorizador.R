...
dados_sujos <- vroom ("Avaliação/Script e dados individualizados/dados_transformados.csv")
summary (dados_sujos)

# Nesta nova versão, vamos usar os nomes dos alunos:
nomes <- read.csv ("Avaliação/Script e dados individualizados/nomes.csv", fileEncoding = "ISO-8859-1")
