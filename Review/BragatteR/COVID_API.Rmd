...
```{r}
# adding url
path <- "https://covidmap.umd.edu/api/resources?indicator=covid&type=daily&country=Brazil&daterange=20200101-20210309"
...
```{r}
# adding url
path <- "https://covidmap.umd.edu/api/resources?indicator=covid&type=daily&country=Brazil&region=Rio%20Grande%20do%20Sul&daterange=20200101-20210309"
